...
const ProfileAccountInfo = ({ profile, formatDate }) => {
  ...
  const pulseStyle = profile.telegramChatId
    ? {
  ...
  return (
    <>
      {/* Sisipkan keyframes langsung di komponen */}
      <style>
        {`
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between items-center py-3 border-b border-gray-100">
              <div>
                <p className="text-sm text-gray-500">Versi Browser</p>
                <p className="font-medium">
                  {profile.deviceInfo?.version || "Tidak diketahui"}
                </p>
              </div>
              <Monitor className="w-5 h-5 text-gray-400" />
            </div>
